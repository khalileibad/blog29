				...
				<div class="tab-pane fade show active" id="nav-add" role="tabpanel" aria-labelledby="nav-add-blog">
					<section id="contact" class="contact border">
						<div class="container">
							<div class="row">
								<div class="col-lg-8">
									<form id="new_blog_form" action="<?php echo URL?>home/new_blog" method="post" role="form" enctype="multipart/form-data" class="php-form">
										<input type="hidden" name="csrf" class="hid_info" value="<?php echo session::get('csrf'); ?>" />
										<div class="form-row">
											<div class="col-md-6 form-group">
												<div class="text-center">
													<img id="blog_image" src="<?php echo URL?>public/IMG/blog/logo.png" width="200px" height="120px" class="rounded" alt="...">
												</div>
											</div>
											<div class="col-md-6 form-group">
				...
				<div class="tab-pane fade active" id="nav-edit" role="tabpanel" aria-labelledby="nav-edit-profile">
					<section id="contact" class="contact border">
						<div class="container">
							<div class="row">
								<div class="col-lg-12">
									<form id="profile_form" action="<?php echo URL?>home/profile" method="post" role="form" enctype="multipart/form-data" class="php-form">
