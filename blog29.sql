...
--
-- Host: localhost
-- Generation Time: Sep 17, 2020 at 12:34 PM
...
(4, 4, 'التجربة 3', 'التجربة التجربة التجربة التجربة التجربة ', 'blog.jpg', 'التجربة,التجربة ', 'اقراء المزيداقراء المزيداقراء المزيداقراء المزيداقراء المزيداقراء المزيداقراء المزيداقراء المزيداقراء المزيداقراء المزيداقراء المزيداقراء المزيداقراء المزيداقراء المزيداقراء المزيداقراء المزيداقراء المزيداقراء المزيداقراء المزيداقراء المزيداقراء المزيداقراء المزيداقراء المزيد', 1, '2020-09-07 00:00:00', 0, 0, '2020-09-14 00:00:00', NULL, NULL),
(5, 2, 'التجربة 4', 'الاختبار الاختبار الاختبار الاختبار الاختبار ', 'blog-1.jpg', 'الاختبار ,التجربة ', 'اقراء الاختبار الاختبار الاختبار  المزيداقراء المزيداقراء المزيداقراء المزيداقراء المزيداقراء المزيداقراء المزيداقراء المزيداقراء الاختبار الاختبار الاختبار المزيداقراء المزيداقراء المزيداقراء المزيداقراء المزيداقراء المزيداقراء المزيداقراء المزيداقراء المزيداقراء الاختبار الاختبار الاختبار الاختبار المزيداقراء المزيد', 1, '2020-09-06 00:00:00', 0, 0, '2020-09-01 00:00:00', NULL, NULL),
(6, 2, 'التجربة 5', 'الاختبار الاختبار الاختبار الاختبار الاختبار ', 'blog-44.jpg', 'الاختبار ,التجربة ', 'اقراء الاختبار الاختبار الاختبار  المزيداقراء المزيداقراء المزيداقراء المزيداقراء المزيداقراء المزيداقراء المزيداقراء المزيداقراء الاختبار الاختبار الاختبار المزيداقراء المزيداقراء المزيداقراء المزيداقراء المزيداقراء المزيداقراء المزيداقراء المزيداقراء المزيداقراء الاختبار الاختبار الاختبار الاختبار المزيداقراء المزيد', 1, '2020-09-05 00:00:00', 0, 0, '2020-09-01 00:00:00', NULL, NULL),
...
INSERT INTO `comments` (`com_id`, `com_blog`, `com_aut_name`, `com_aut_phone`, `com_aut_email`, `com_comment`, `com_likes`, `create_at`, `accept_by`, `accept_at`) VALUES
...
INSERT INTO `mail_list` (`mail_id`, `mail_name`, `mail_active`, `create_at`) VALUES
...
INSERT INTO `staff` (`staff_id`, `staff_name`, `staff_phone`, `staff_email`, `staff_type`, `staff_address`, `staff_img`, `staff_active`, `staff_about`, `staff_face`, `staff_twitter`, `staff_linked`, `staff_instagram`, `staff_uname`, `staff_pass`, `create_at`, `create_by`, `update_at`, `update_by`) VALUES
